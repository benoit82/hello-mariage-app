...
const Policy: NextPage = () => {
  ...
  const content: JSX.Element = (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Hello Mariage.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Hello Mariage, accessible from{' '}
            <a
              href="www.hellomariage.fr"
      ...
      <ul>
        <li>By email: office@hello-mariage.com</li>
      </ul>
    </>
  );
